...
public class BleConnectionCompat {
	...
	private String TAG = "BleConnectionCompat";
	...
	public BluetoothGatt connectGatt(BluetoothDevice remoteDevice, boolean autoConnect,
		...
		try {
			...
			Log.w(TAG, "Error during reflection");
			return connectGattCompat(bluetoothGattCallback, remoteDevice, true);
		}
	}
